...
const (
	...
	SimpleBank_LogineUser_FullMethodName = "/pb.SimpleBank/LogineUser"
)
...
type SimpleBankClient interface {
	...
	LogineUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*LoginUserResponse, error)
}
...
func (c *simpleBankClient) LogineUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*LoginUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginUserResponse)
	err := c.cc.Invoke(ctx, SimpleBank_LogineUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleBankServer interface {
	...
	LogineUser(context.Context, *LoginUserRequest) (*LoginUserResponse, error)
...
func (UnimplementedSimpleBankServer) LogineUser(context.Context, *LoginUserRequest) (*LoginUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LogineUser not implemented")
}
...
func _SimpleBank_LogineUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleBankServer).LogineUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimpleBank_LogineUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).LogineUser(ctx, req.(*LoginUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LogineUser",
			Handler:    _SimpleBank_LogineUser_Handler,
		},
	},
